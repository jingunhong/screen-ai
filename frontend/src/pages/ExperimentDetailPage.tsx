  ...
  return (
    <div className="bg-slate-50 dark:bg-background-dark h-screen flex flex-col">
      ...
      <div className="flex flex-1 overflow-hidden relative">
        {/* Left Sidebar */}
        <aside className="flex w-72 flex-col border-r border-slate-200 dark:border-slate-800 bg-white dark:bg-[#111a22] h-full shrink-0">
          ...
          <div className="p-6 pb-4">
            ...
            <div className="flex items-center gap-3 mb-4">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-xs text-slate-500 dark:text-slate-400 truncate">{experiment.project_name}</p>
              </div>
            </div>

            {experiment.description && (
              <p className="text-xs text-slate-500 dark:text-slate-400 mb-4 line-clamp-2">{experiment.description}</p>
            )}
          </div>
              ...
              {plates.map((plate) => {
                ...
                return (
                  ...
                  >
                    ...
                    <span
                      className={`ml-auto text-xs ${isSelected ? 'text-blue-500 dark:text-blue-400' : 'text-slate-400 dark:text-slate-500'}`}
                    >
                      {plate.format}
                    </span>
                  </button>
